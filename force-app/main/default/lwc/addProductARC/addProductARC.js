...
import findProducts from '@salesforce/apex/AddProductARC.findProduct';
import findProductsOptimized from '@salesforce/apex/AddProductARC.findProductsOptimized';
import saveProducts from '@salesforce/apex/AddProductARC.saveProducts';
import getproductfamily from '@salesforce/apex/AddProductARC.getproductfamily';
import getCustomerDiscount from '@salesforce/apex/AddProductARC.getCustomerDiscount';
...
export default class AddProductPageARC extends NavigationMixin(LightningElement) {
    cols = COLS;
